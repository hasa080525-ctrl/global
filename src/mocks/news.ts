...
export const NEWS_ITEMS: NewsItem[] = [
  {
    ...
    metaDescription:
      "미국·IB·영국식 커리큘럼별로 AP·IB·SAT 시험이 몰리는 시기가 달라, 학교 방학에 맞춰 SAT 준비 시기를 조정하는 것이 효율적입니다.",
    sections: [
      {
        heading: "커리큘럼마다 다른 시험 성수기",
        body: "국제학교 입시 전문업체 베테랑스에듀가 42개국 1만 9,824명(2026년 7월 기준)의 수강 데이터를 바탕으로 SAT 준비 일정 설계 방안을 공개했습니다. 미국식 커리큘럼 학교는 AP 시험이 5월에 몰리고, IB 학교는 평가가 봄학기에 집중되며, 영국식 커리큘럼 학교는 여름에 시험이 몰리는 등 학교 유형별로 학사 일정이 크게 다릅니다.",
      },
      {
        heading: "방학 기간에 SAT 집중 배치",
        body: "이런 차이 때문에 자녀가 다니는 국제학교의 커리큘럼 유형에 따라 AP·IB 시험이 몰리는 시기를 피해, 학교 방학 기간에 SAT 준비를 집중적으로 배치하는 것이 학습 부담을 줄이는 데 효율적입니다. 국제학교 재학 중이라면 학교 자체 시험 일정과 SAT·ACT 등 외부 시험 일정을 함께 놓고 학년별 로드맵을 미리 짜두는 것이 좋습니다.",
      },
    ],
    image:
  ...
  },
  {
    ...
    metaDescription:
      "AP 역사 3과목 서술형이 전원 필수 응시로 바뀌고 AP 통계는 완전 디지털 시험으로 전환됩니다(2027년 5월 시행).",
    sections: [
      {
        heading: "선택형에서 전원 응시형으로 바뀌는 서술형 문제",
        body: "칼리지보드 공식 발표에 따르면 2027년 5월 AP 미국사(APUSH)·유럽사·세계사(모던) 시험부터 학생들은 기존에 문항을 골라 답하던 단답형 서술형(SAQ)을 폐지하고 3개 문항 모두에 답해야 합니다. 각 문항은 서로 다른 시대를 다루며 1번은 2차 사료, 2번은 1차 사료, 3번은 사료가 아닌 자료(지도·통계표 등)를 활용합니다. 장문 서술형(LEQ) 역시 선택지 없이 1개 필수 문항으로 바뀌지만, 채점 기준과 배점, 객관식 문항, 교과 내용 자체는 변경되지 않습니다. 같은 해 AP 통계 시험도 하이브리드(디지털+종이) 방식에서 완전 디지털 방식으로 전환되며, 서술형 문항 수는 6개에서 4개로 줄고 문항당 배점은 4점에서 10점으로 상향됩니다.",
      },
      {
        heading: "국제학교 학생은 지금부터 준비 방식을 바꿔야",
        body: "이번 개편은 2026-27학년도에 AP 역사·통계 과목을 듣는 학생들부터 곧바로 적용 대상이 되므로, '자신 있는 문항만 골라 쓰는' 기존 전략이 더 이상 통하지 않습니다. 역사 과목은 시대별로 고르게 사료 해석 연습을 해야 하고, 통계 과목은 완전 디지털 환경에서 계산기·그래프 도구를 화면상으로 빠르게 다루는 훈련이 병행돼야 합니다. 국제학교 자녀를 둔 학부모는 학교의 Bluebook 실기 연습 시작 시점을 확인하고, 늦어도 겨울방학 전까지 새 문제 유형에 충분히 익숙해지도록 학습 일정을 조정하는 것이 안전합니다.",
      },
    ],
    image:
      "/news-images/school-news.png",
  },
  {
    ...
    metaDescription:
      "NLCS Jeju가 2026 IB 디플로마 세계 47위, 2년 연속 한국 1위를 기록했습니다. 응시생 109명 평균 37.16점입니다.",
    sections: [
      {
        heading: "109명 응시, 평균 37.16점으로 세계 47위",
        body: "NLCS Jeju의 2026학년도 IB 디플로마 응시생 109명은 평균 37.16점을 기록해 세계 공동 47위에 올랐습니다. 100명 이상이 응시한 대규모 학년 기준으로는 세계 최상위권에 해당하는 성과입니다.",
      },
      {
        heading: "2년 연속 한국 내 1위",
        body: "이번 결과로 NLCS Jeju는 2년 연속 한국 국제학교 중 IB 디플로마 평균 점수 1위를 지켰습니다. 제주 국제교육도시 내 학교들 간 경쟁이 치열해지는 가운데, 안정적으로 상위권을 유지하고 있다는 평가입니다.",
      },
      {
        heading: "9월 12일 서울에서 설명회 개최",
        body: "NLCS Jeju는 9월 12일 서울 레이어 스튜디오 한남에서 4~7세 자녀를 둔 학부모 대상 'NLCS Jeju Play Day in Seoul' 행사를 엽니다. 영어 체험수업과 놀이 활동을 통해 학교 수업 방식과 교육 환경을 경험할 수 있으며, 입학 담당자와의 상담도 가능합니다. 제주 이주나 국제학교 진학을 고려 중인 수도권 학부모라면 참고할 만합니다.",
      },
    ],
    image:
      "/news-images/school-news.png",
  ...
  },
  {
    ...
    metaDescription:
      "케임브리지 A-Level 결과가 8월 11일 발표됐습니다. 응시 73만7천 건, 전년 대비 5% 증가 등 주요 통계를 정리했습니다.",
    sections: [
      {
        heading: "응시 73만 7천 건, 전년 대비 5% 증가",
        body: "케임브리지 인터내셔널이 8월 11일 2026년 6월 시험 세션의 AS·A-Level 결과를 발표했습니다. 128개국 약 3,500개교 소속 학생 36만 8천여 명이 결과를 받았으며, 총 응시 건수는 73만 7천 건으로 2025년 대비 5% 증가했습니다.",
      },
      {
        heading: "인기 과목은 작년과 동일 — 영어일반논술·수학·물리·화학",
        body: "가장 많이 응시된 과목은 작년과 마찬가지로 English General Paper, 수학, 물리, 화학, 영어(English Language) 순이었습니다. 지역별로는 중국 7%, 방글라데시 5%, 인도네시아 12%, 사우디아라비아 5% 등 특정 국가에서 응시자가 크게 늘었습니다.",
      },
      {
        heading: "중동 지역 분쟁, 대안 평가 방식 적용",
        body: "6월 시험 기간 중동 지역 분쟁으로 학교가 문을 닫으면서 약 3만 명의 학생이 정상적으로 시험을 치르지 못했습니다. 이들은 '증빙자료 포트폴리오(portfolio of evidence)' 방식으로 평가받았으며, 시험위원이 채점하고 대학에서도 인정하는 대안 평가 방식입니다.",
      },
      {
        heading: "디지털 응시, 여러 과목으로 첫 확대",
        body: "이번 시험 세션은 케임브리지가 여러 과목에서 온스크린(디지털) 응시를 선택지로 제공한 첫 사례입니다. 종이 시험 대신 디지털 응시를 선호하는 학생들에게 새로운 선택지가 열린 셈입니다.",
      },
      {
        heading: "국제학교 A-Level 학생이 확인할 것",
        body: "이미 결과를 확인했다면 UCAS Track에서 대학 합격 확정 여부를 점검하고, Clearing이 필요한 경우 대안 대학 리스트를 서둘러 준비하는 것이 좋습니다. IGCSE 결과는 일주일 뒤인 8월 18일 별도 발표되니, IGCSE 응시생은 해당 날짜를 확인해두세요.",
      },
    ],
    image:
      "/news-images/curriculum.png",
  },
  {
    ...
    metaDescription:
      "조지타운대가 8월 1일부터 첫 Common App 지원을 받습니다. 자체 지원서와 병행 운영되며 합격에 유불리는 없습니다.",
    sections: [
      {
        heading: "무엇이 바뀌었나 — 8월 1일부터 Common App 수용",
        body: "조지타운대학교는 그동안 수십 년간 자체 온라인 지원서 시스템만을 고집해온 몇 안 되는 명문대 중 하나였습니다. 이 학교가 2026년 8월 1일부터 처음으로 Common App을 통한 지원도 받기 시작했습니다. 이번 변화는 2027학년도 입시, 즉 2031년 졸업 예정 입학생부터 적용됩니다.",
      },
      {
        heading: "자체 지원서 vs Common App — 선택은 자유",
        body: "지원자는 조지타운 자체 지원서와 Common App 중 하나를 선택해 지원할 수 있습니다. 입학사정관 측은 두 지원서 플랫폼 모두를 통해 지원하는 학생들을 환영한다고 밝혔으며, 어느 쪽을 선택하든 합격 가능성에는 영향을 주지 않는다고 명확히 했습니다.",
      },
      {
        heading: "보충 에세이는 두 경로 모두 필수",
        body: "Common App으로 지원하더라도 조지타운 고유의 보충 에세이는 그대로 유지됩니다. 학문적 관심사와 학교 가치관의 연결점을 설명하는 조지타운 특화 질문에 답해야 하는 점은 자체 지원서로 지원할 때와 동일합니다.",
      },
      {
        heading: "국제학교 학생이 확인할 것",
        body: "조지타운을 포함해 여러 학교에 동시 지원할 계획이라면, Common App으로 한 번에 여러 대학에 지원하는 편이 서류 관리에 유리할 수 있습니다. 다만 어느 플랫폼을 택하든 조지타운 고유의 보충 에세이 준비 시간은 별도로 확보해두는 것이 안전합니다.",
      },
    ],
    image:
      "/news-images/admissions.png",
  },
  {
    ...
    metaDescription:
      "ISHCMC 2026학년도 IB 결과, 졸업생 116명 평균 34.5점(세계 평균 30.9점), 만점자 2명을 기록했습니다.",
    sections: [
      {
        heading: "졸업생 116명, 평균 34.5점",
        body: "ISHCMC의 2026학년도 IB 디플로마 졸업생 116명은 평균 34.5점을 기록해 세계 평균 30.9점을 크게 웃돌았습니다. 이 중 2명은 45점 만점을 받았고, 40점 이상 취득자는 8명(약 10%), 35점 이상은 40% 이상, 30점 이상은 85%에 달했습니다.",
      },
      {
        heading: "디플로마 취득률 95%, 이중언어 취득률도 세계 평균 2배 이상",
        body: "디플로마 취득률은 95%로 세계 평균(83%)을 웃돌았습니다. 이중언어 디플로마 취득률은 64%로 세계 평균(27%)의 두 배 이상을 기록했습니다. 마르코 롱모어 교장은 이번 결과가 \"학생들의 헌신과 회복력, 성장을 보여주는 증거이며, 이들의 여정을 함께 만들어온 교사와 가정, 커뮤니티의 뒷받침이 있었기에 가능했다\"고 밝혔습니다.",
      },
      {
        heading: "베트남 주재원 자녀·국제학교 학부모에게 의미",
        body: "베트남(호치민·하노이)은 주재원 발령으로 자녀를 국제학교에 보내는 가정이 많은 지역 중 하나입니다. 이번 결과처럼 IB 성과가 학교·코호트별로 크게 갈리는 만큼, 전학이나 입학을 앞두고 있다면 목표 학교의 최근 IB 성적 추이와 이중언어 디플로마 운영 여부를 함께 확인해두는 것이 진학 전략을 세우는 데 도움이 됩니다.",
      },
    ],
    image:
      "/news-images/school-news.png",
  ...
  },
  {
    ...
    metaDescription:
      "컬럼비아대가 2027-28학년도 입시부터 SAT·ACT를 의무화하며 아이비리그 8개교 전원이 테스트 옵셔널을 폐지했습니다.",
    sections: [
      {
        heading: "\"테스트 옵셔널 시대의 종언\"",
        body: "컬럼비아대는 다년간의 교수진 검토를 거쳐 \"표준화 시험 점수는 다른 요소들과 함께 학생의 학업 성공 가능성을 보여주는 유용한 지표\"라는 결론을 내렸다고 밝혔습니다. 현재 진행 중인 2026-27학년도 입시까지는 기존의 테스트 옵셔널을 유지하되, 2027-28학년도(2028년 가을학기 입학) 지원자부터는 SAT 또는 ACT 점수 제출이 의무화됩니다. 2020년 팬데믹 이후 테스트 옵셔널을 유지해 온 컬럼비아는 아이비리그 8개교 중 가장 늦게 정책을 전환한 학교로, 하버드·예일·다트머스·브라운·펜실베이니아·프린스턴·코넬에 이어 합류하면서 아이비리그 전체가 다시 표준화 시험을 요구하게 됐습니다.",
      },
      {
        heading: "국제학교 학부모가 챙겨야 할 것",
        body: "국제학교·해외 교육과정을 밟으며 미국 명문대를 목표로 하는 학생에게는 \"시험 없이도 지원 가능하다\"는 전제가 사실상 사라졌다고 봐야 합니다. 지원 시점보다 1~2년 앞서 SAT·ACT 준비를 시작해 고2 말~고3 초까지 목표 점수를 확보해 두는 것이 안전하며, 내신(GPA)·비교과 활동과 함께 표준화 시험 성적까지 균형 있게 관리하는 장기 로드맵을 다시 세워야 합니다.",
      },
    ],
    image:
      "/news-images/admissions.png",
  ...
  },
  {
    ...
    metaDescription:
      "제주영어교육도시 5번째 국제학교 FSAA, 당초 2026년 9월 목표에서 2028년 9월 개교로 최종 연기.",
    sections: [
      {
        heading: "과학·예술 중심 STEAM 교육과정",
        body: "FSAA는 미국 조지아주 애틀란타 소재 풀턴 사이언스 아카데미의 한국 분교로, 과학과 예술교육에 중점을 둔 STEAM 교육과정과 미국 대학과목 선이수제(AP) 프로그램을 운영합니다. 내국인 학생은 국어·사회(역사, 한국사) 교육을 필수로 이수합니다.",
      },
      {
        heading: "유치원~12학년, 63학급 1,354명 규모",
        body: "제주도교육청 국제학교설립·운영심의위원회로부터 설립계획을 정식 승인받았으며, 서귀포시 대정읍 제주영어교육도시 H-13·H-14구역에 유치원(PK)부터 12학년까지 63학급 1,354명 규모로 들어섭니다. 국내 최초로 순수민간자본 100%로 운영되는 K-12 국제학교입니다.",
      },
      {
        heading: "개교 목표, 2026년 9월에서 2028년 9월로 연기",
        body: "당초 2026년 9월 14일 개교를 목표로 했으나, 제주도교육청의 수 차례 보완 요구(학비 책정, 학생 충원 계획, 재정 건전성 등)와 교육부장관 동의·도시계획시설 실시계획 인가 절차 등으로 일정이 2027년을 거쳐 2028년 9월로 최종 조정됐습니다. 2022년 거제대학교와 애서튼국제외국인학교를 인수해 운영해온 학교법인 덕부학원이 개교를 준비 중이며, 국제학교 진학을 고려 중인 학부모라면 변경된 일정을 참고해 계획을 세우는 것이 좋습니다.",
      },
    ],
    image:
      "/news-images/school-news.png",
  },
  {
    ...
    metaDescription:
      "연세대 2026학년도 9월 신입학 12년 특례 모집요강 — 원서접수 3월 10~12일, 서류평가 100% 선발.",
    sections: [
      {
        heading: "원서접수 단 3일, 서류업로드 방식도 변경",
        body: "원서접수는 2026년 3월 10일(화) 오전 10시부터 12일(목) 오후 5시까지 진행되며, 서류업로드는 13일(금) 오후 5시까지 완료해야 합니다. 기존 ZIP 파일 일괄 업로드 방식에서 개별 PDF 파일 10개 이내로 제출 방식이 바뀌었으니, 서류를 미리 파일별로 정리해두는 것이 좋습니다.",
      },
      {
        heading: "서류평가 100%, 학업·진로·공동체역량 종합 평가",
        body: "전 모집단위에서 서류평가 100%로 일괄 선발하며, 지원자의 학업역량·진로역량·공동체역량을 종합적으로 평가합니다. 합격자 발표는 2026년 6월 5일(금) 오후 5시로 예정되어 있습니다.",
      },
      {
        heading: "인공지능융합대학 '모빌리티시스템전공' 신설",
        body: "이번 모집요강에서는 인공지능융합대학 내 '모빌리티시스템전공'이 새로 신설됐습니다. 해당 전공은 전 교육과정을 송도 국제캠퍼스에서 이수해야 하는 점이 특징으로, 지원 전 캠퍼스 소재지도 함께 확인해두는 것이 좋습니다.",
      },
    ],
    image:
      "/news-images/school-news.png",
