...
export const NEWS_ITEMS: NewsItem[] = [
  ...
  {
    id: "48",
    keywords: "풀턴 사이언스 아카데미 애서튼, FSAA 제주, 제주영어교육도시 5번째 국제학교, 제주 국제학교 개교, STEAM 국제학교",
    title: "제주영어교육도시 5번째 국제학교 'FSAA' 9월 14일 개교 목표",
    category: "학교소식",
    date: "2024-03-21",
    summary:
      "미국 조지아주 풀턴 사이언스 아카데미의 한국 분교 '풀턴 사이언스 아카데미 애서튼(FSAA)'이 제주영어교육도시에 국내 최초 순수민간자본 국제학교로 들어섭니다. 유치원~12학년 63학급 1,354명 규모로 2026년 9월 14일 개교를 목표로 합니다.",
    metaDescription:
      "제주영어교육도시 5번째 국제학교 FSAA가 STEAM·AP 교육과정으로 2026년 9월 14일 개교를 목표로 합니다.",
    sections: [
      {
      ...
      {
        heading: "애서튼국제외국인학교 운영 법인이 개교 준비",
        body: "FSAA 개교에는 2022년 거제대학교와 애서튼국제외국인학교를 인수해 운영해온 학교법인 덕부학원이 참여합니다. 개교 목표일은 2026년 9월 14일로, 국제학교 진학을 고려 중인 학부모라면 새 학교의 정원·전형 일정을 미리 확인해두는 것이 좋습니다.",
      },
    ],
    image:
      "/news-images/school-news.png",
