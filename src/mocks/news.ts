...
export const NEWS_ITEMS: NewsItem[] = [
  {
    ...
    metaDescription:
      "美 유학생 비자 규제가 강화되며 EB-5 투자이민이 대안으로 떠오르고 있습니다. 9월 30일 그랜드파더링 기한을 정리했습니다.",
    sections: [
      {
        heading: "유학·취업 문턱이 함께 높아졌다",
        body: "F-1 학생비자의 무기한 체류(D/S) 제도가 폐지되고 최대 4년의 고정 체류기간이 도입된 데 이어, 2027회계연도부터는 H-1B 취업비자도 임금 수준에 따라 선발 기회를 차등 부여하는 방식으로 바뀝니다. 졸업 후 미국에 남아 일할 수 있을지 예측하기가 한층 어려워지면서, 유학 준비 중인 가정들 사이에서 체류 신분 자체를 안정적으로 확보하는 방안에 대한 관심이 커지고 있습니다.",
      },
      {
        heading: "대안으로 떠오른 EB-5 투자이민",
        body: "최소 80만 달러를 미국 내 지정 사업에 투자하는 EB-5 투자이민이 대안으로 주목받고 있습니다. 투자자 본인뿐 아니라 배우자와 21세 미만 미혼 자녀까지 함께 영주권을 취득할 수 있어, 자녀의 학생비자 신분 불확실성을 근본적으로 해소하려는 가정들이 관심을 보이고 있습니다.",
      },
      {
        heading: "9월 30일, 그랜드파더링 기한",
        body: "2026년 9월 30일까지 I-526E 청원서를 접수하면 현재의 그랜드파더링 보호 조항이 적용됩니다. 이 기한을 넘기면 향후 제도 변경 시 적용받는 조건이 달라질 수 있어, 투자이민을 검토 중인 가정이라면 서류 준비 일정을 서둘러야 합니다.",
      },
      {
        heading: "미국 유학 준비 가정이 확인할 것",
        body: "당장 투자이민을 결정하지 않더라도, F-1 체류기간 4년 제한과 OPT(일반 12개월·STEM 최대 36개월) 조건이 자녀의 전공·졸업 시점과 어떻게 맞물리는지 미리 계산해두는 것이 안전합니다. 투자이민 절차는 이민 전문 변호사와 개별 상담을 통해 자격 요건과 비용을 정확히 확인하는 것이 가장 확실합니다.",
      },
    ],
    image:
  ...
  },
  {
    ...
    metaDescription:
      "국제학교 열풍 속 미인가 교육시설이 늘고 있어, 교육부가 단속 강화를 발표했습니다. 학부모가 확인해야 할 점을 정리했습니다.",
    sections: [
      {
        heading: "국제학교 열풍과 미인가 시설의 그림자",
        body: "국제학교에 대한 학부모 관심이 커지면서, 학년별로 학생을 모집하고 평일 전일제로 정규 교과를 가르치지만 정식 학교 설립 인가는 받지 않은 시설도 함께 늘고 있습니다. 해외 교육기관 인증이나 학원 등록을 받았다고 해서 학교 설립 인가를 받았다는 뜻은 아니라는 점이 혼동을 낳는 지점입니다.",
      },
      {
        heading: "교육부, 4월 단속 강화 발표",
        body: "교육부는 2026년 4월 미인가·미등록 교육시설에 대한 감독과 단속을 강화하겠다고 밝혔습니다. 위법 사실을 시정하지 않는 시설에 대해서는 고발이나 수사 의뢰 등 적극적인 조치를 취하겠다는 방침입니다.",
      },
      {
        heading: "학부모가 확인해야 할 것",
        body: "국제학교를 알아볼 때는 정식 학교 설립 인가 여부, IB·AP·케임브리지 등 커리큘럼의 공식 인증 상태, 교사 자격, 시설 요건 충족 여부를 먼저 확인하는 것이 안전합니다. '해외 교육기관 인증'이나 '학원 등록'만으로는 정식 학교 인가를 대신할 수 없다는 점을 특히 유의해야 합니다.",
      },
      {
        heading: "이미 재학 중이라면",
        body: "자녀가 이미 다니고 있는 학교라면, 학교 측에 정식 인가 상태와 관련 서류를 요청해 확인해보는 것이 좋습니다. 편입이나 전학을 고려 중이라면 지원 전에 해당 학교의 인가·인증 현황을 미리 검증하는 절차를 거치는 것이 안전합니다.",
      },
    ],
    image:
