...
export default function AboutPage() {
  return (
    <main className="bg-background-50 text-foreground-950">
      <title>소개 | 서울 국제학교전문과외 – IB·AP·IGCSE·SAT 1:1 화상 과외</title>
      ...
      <meta name="keywords" content="국제학교 전문과외, 국제학교 과외 추천, IB 과외, AP 과외, IGCSE 과외, 화상 과외, 서울 국제학교 과외, 국제학교 1:1 과외, 강남 국제학교 과외, 국제학교 과외 비용" />
